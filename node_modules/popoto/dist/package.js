...
export var dependencies = {"d3":"^7.8.1"};
export var devDependencies = {"@babel/core":"^7.20.12","babel-jest":"^29.3.1","babel-plugin-transform-es2015-modules-commonjs":"^6.26.2","jest":"^29.3.1","jest-canvas-mock":"^2.4.0","jest-environment-jsdom":"^29.3.1","json2module":"^0.0.3","rimraf":"^3.0.2","rollup":"^2.79.1","rollup-plugin-copy":"^3.4.0","rollup-plugin-node-resolve":"^5.2.0","uglify-js":"^3.17.4","uglifycss":"^0.0.29"};
